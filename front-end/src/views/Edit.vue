        ...
        <form @submit="handleSubmitForm" method="post">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <div class="relative">
                        <select v-model="uploadForm.category" class="block appearance-none bg-transparent w-full border-b border-gray-700 text-gray-700 py-3 pr-8 leading-tight focus:outline-none focus:border-green-500" id="grid-state" required>
            ...
            <div class= "flex flex-wrap -mx-3 mb-2 mt-24 justify-center items-center">
                <button class=" text-xl bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 mx-2 border rounded" type="submit">Confirm</button>
                <a href="/Inventory">
                    <button class="text-xl bg-red-500 hover:bg-green-700 text-white font-bold py-2 px-4 mx-2 border rounded">Cancel</button>
                </a>
            </div>
...
export default {
    ...
    props: ['curId', 'curName', 'curCategory', 'curQuantityOriginal', 'curUnit', 'curQuantityLeft', 'curDate'],
    data() {
        return {
            uploadForm: {
                id: Number(this.curId),
                name: this.curName,
                category: this.curCategory,
                quantityOriginal: this.curQuantityOriginal,
                unit: this.curUnit,
                quantityLeft: this.curQuantityLeft,
                date: this.curDate
            },
            categories : [
                "Fruits & Vegetables",
    ...
    methods: {
        ...
        handleSubmitForm(e) {
            ...
            axios.post("/api/edit", this.uploadForm, config)
            .then(res => {
                // success
